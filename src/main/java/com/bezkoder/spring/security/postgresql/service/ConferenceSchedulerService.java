        ...
        if (!conferenceList.isEmpty()) {
            for (int i = 0; i < conferenceList.size(); i++) {
                ...
                if (mins == conferenceReminderTime) {
                    ...
                    Message message = new Message("notifications@syneurgy.com", userEmail, "It's time for your habit.", "Hi, " + userName + ". You have a conference in " + conferenceReminderTime  +"minutes. Please prepare something to grow your habits." );
